...
#include "../ComputerGraphics/View/gamewidget.h"
...
QT_MOC_LITERAL(1, 11, 15), // "mouseClickEvent"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13), // "keyPressEvent"
QT_MOC_LITERAL(4, 42, 12) // "spotLighting"

    },
    "GameWidget\0mouseClickEvent\0\0keyPressEvent\0"
    "spotLighting"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::mouseClickEvent)) {
                *result = 0;
            }
        }
        {
            typedef void (GameWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::keyPressEvent)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void GameWidget::mouseClickEvent()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void GameWidget::keyPressEvent()
{
